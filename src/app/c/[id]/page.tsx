...
export async function generateMetadata({
  ...
  const title = `Shared comparison ${shortId} — CompareAnything`;
  const description =
    "Shared comparison generated by CompareAnything. Paste two things, tell us what you care about, and we’ll break it down with a bit of humour.";
